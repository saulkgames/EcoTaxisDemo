      ...
      <table class="table table-bordered">
        ...
        <tbody>
            ...
            if(isset($_GET['buscar'])) {
              ...
              while($row1 = mysqli_fetch_assoc($sear)) { ?>
                <tr>
                  ...
                  <td>
                    <a href="updateadmin.php?idCruce=<?php echo $row1['idCruce']?>" class="btn btn-secondary">
                      <i class="fas fa-marker"></i>
                    </a>
                    <a href="deleteadmin.php?idCruce=<?php echo $row1['idCruce']?>" class="btn btn-danger">
          ...
          <tr>
            ...
            <td>
              <a href="updateadmin.php?idCruce=<?php echo $row['idCruce']?>" class="btn btn-secondary">
                <i class="fas fa-marker"></i>
              </a>
              <a href="deleteadmin.php?idCruce=<?php echo $row['idCruce']?>" class="btn btn-danger">
                <i class="far fa-trash-alt"></i>
              </a>
            </td>
          </tr>
