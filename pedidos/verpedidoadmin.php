    ...
    <div class="col-md-8">
      <table class="table table-bordered">
        ...
        <?php 
          ...
          $query = "SELECT IdPedido, Telefono, Colonia, Calleynum, Entrecalle, Observacion, Fecha, Ntaxi, Nombre, estado FROM pedidos JOIN usuario ON pedidos.Usuario_IDUsuario = usuario.IDUsuario ORDER BY CASE WHEN pedidos.Ntaxi IS NULL THEN 0 ELSE 1 END, pedidos.IdPedido DESC LIMIT 200";
