        ...
        <?php 
            if(isset($_GET['buscar'])) {
              ...
              while($row = mysqli_fetch_assoc($sear)) { ?>
                ...
                <td>
                  <a href="update.php?IdPedido=<?php echo $row['IdPedido']?>" class="btn btn-secondary">
                      <i class="fas fa-marker"></i>
                  </a>
                  <a href="delete.php?IdPedido=<?php echo $row['IdPedido']?>" class="btn btn-danger">
                    <i class="far fa-trash-alt"></i>
                  </a>
                  <a href="modal.php?IdPedido=<?php echo $row['IdPedido']?>" class="btn btn-primary">
                    Reportar
                  </a>
                </td>
                </tr>
